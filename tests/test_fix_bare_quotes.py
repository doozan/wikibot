...
def test_get_params_old():
    ...
    for text, expected in [
        (
            """'''2007''', William D. Popkin, ''Evolution of the Judicial Opinion: Institutional and Individual Styles'', NYU Press ({{ISBN|9780814767498}}), page 104:""",
            {'year': '2007', 'author': 'William D. Popkin', "title": 'Evolution of the Judicial Opinion: Institutional and Individual Styles', "publisher": "NYU Press", "isbn": "9780814767498", "page": "104"}
        ),
        (
            # No publisher
            """'''2017''', Rebecca Tuhus-Dubrow, ''Personal Stereo'' ({{ISBN|1501322834}}), page 45:""",
            {'year': '2017', 'author': 'Rebecca Tuhus-Dubrow', 'title': 'Personal Stereo', 'isbn': '1501322834', 'page': '45'}
        ),
        (
            # Multi authors
            ...
            {'year': '2015', 'author': 'Thomas J. Gradel', 'author2': 'Dick Simpson', 'title': 'Corrupt Illinois: Patronage, Cronyism, and Criminality', 'publisher': 'University of Illinois Press', 'isbn': '9780252097034', 'page': '117'}
        ),
        (
            # Author with , Jr.
            """'''2010''', E. San Juan, Jr., ''SUTRANG KAYUMANGGI'', Lulu.com {{ISBN|9780557274277}}, page 24""",
            {'year': '2010', 'author': 'E. San Juan, Jr.', 'title': 'SUTRANG KAYUMANGGI', 'publisher': 'Lulu.com', 'isbn': '9780557274277', 'page': '24'}
        ),
        (
            """'''1998''', Anton Pavlovich Chekhov, Ronald Hingley, ''Five Plays'', Oxford University Press, USA ({{ISBN|9780192834126}}), page 148:""",
            {'year': '1998', 'author': 'Anton Pavlovich Chekhov', 'author2': 'Ronald Hingley', 'title': 'Five Plays', 'publisher': 'Oxford University Press, USA', 'isbn': '9780192834126', 'page': '148'}
        ),
        (
        ...
        (
            ...
            {'year': '2013', 'author': 'Larry Munson', 'author2': 'Tony Barnhart', 'title': 'From Herschel to a Hobnail Boot: The Life and Times of Larry Munson', 'publisher': 'Triumph Books', 'isbn': '9781623686826', 'page': '52'}
        ),
        (
        ...
        (
            ...
            {'year': '2016', 'author': 'Justin O. Schmidt', 'title': 'The Sting of the Wild', 'publisher': 'Johns Hopkins University Press', 'isbn': '978-1-4214-1928-2', 'page': '55'}
        ),
        (
        ...
        (
            ...
            {'year': '2010', 'author': 'Rachel Cohn', 'title': 'Very Lefreak', 'publisher': 'Random House', 'isbn': '9780375895524', 'chapterurl': 'http://books.google.com/books?id=B7jw88zb_jEC&pg=PT19&dq=Wikipediaing', 'chapter': '3'}
        ),
        (
            # gbooks for page
        ...
        (
            ...
            {'year': '1994', 'author': 'R. Jeffrey Ringer', 'title': 'Queer Words, Queer Images: Communication and Construction of Homosexuality', 'isbn': '0814774415', 'page': '230'}
        ),
        (
            # p&nbsp;66
           """'''2003''', Gillian Cloke, ''This Female Man of God: Women and Spiritual Power in the Patristic Age, 350–450 AD'', Routledge, {{ISBN|9781134868254}}, [https://books.google.com/books?id=KCGIAgAAQBAJ&lpg=PA66&dq=%22inchastity%22&pg=PA66#v=onepage&q=%22inchastity%22&f=false p.&nbsp;66]:""",
            {'year': '2003', 'author': 'Gillian Cloke', 'title': 'This Female Man of God: Women and Spiritual Power in the Patristic Age, 350–450 AD', 'publisher': 'Routledge', 'isbn': '9781134868254', 'pageurl': 'https://books.google.com/books?id=KCGIAgAAQBAJ&lpg=PA66&dq=%22inchastity%22&pg=PA66#v=onepage&q=%22inchastity%22&f=false', 'page': '66'}
        ),
        (
            # translator
        ...
        (
            ...
            {'year': '2013', 'author': 'Judy Faust', 'author2': 'Punch Faust', 'title': 'The MOTs File: Memories, Observations, and Thoughts', 'publisher': 'AuthorHouse', 'isbn': '9781491827123', 'page': '88'}
        ),
        (
            # Translator first
        ...
        (
            ...
            {'year': '2011', 'author': 'Steve Urick', 'title': 'Practical Christian Living', 'page': '214', 'isbn': '978-1-4520-8297-4'}
        ),
        (
            # publisher is link
        ...
        (
            ...
            {'year': '2006', 'author': 'Kelly Pyrek', 'title': 'Forensic Nursing', 'page': '514', 'isbn': '084933540X'}
        ),
        (
            # Volume
            """'''2008''', John L. Capinera, ''Encyclopedia of Entomology'' {{ISBN|1402062427}}, volume 4, page 3326:""",
            {'year': '2008', 'author': 'John L. Capinera', 'title': 'Encyclopedia of Entomology', 'volume': '4', 'page': '3326', 'isbn': '1402062427'}
        ),
        (
        ...
        (
            ...
            {'year': '1936', 'author': '{{w|George Weller}}', 'title': 'Clutch and Differential', 'page': '196', 'publisher': 'Ayer', 'year_published': '1970', 'isbn': '0836936590'}
        ),
        (
            ...
            {'year': '2007', 'author': 'David J. Wishart', 'title': 'Encyclopedia of the Great Plains Indians', 'pageurl': 'http://books.google.ca/books?id=646oX4hA8EkC&lpg=PA32&dq=%22quilled%22&pg=PA32#v=onepage&q=%22quilled%22&f=false', 'page': '32', 'publisher': 'University of Nebraska Press', 'isbn': '0-8032-9862-5'}
        ),
        (
        ...
        (
            ...
            {'year': '1978', 'author': 'Marguerite V. Burke', 'title': 'The Ukrainian Canadians', 'page': '48', 'publisher': 'Van Nostrand Reinhold', 'location': 'Toronto', 'isbn': '0442298633'}
        ),
        (
            # Publisher location
        ...
        (
            ...
            {'year': '2005', 'editors': 'John Schaeffer; Doug Pratt', 'title': 'Appendix: Gaiam Real Goods Solar Living Sourcebook', 'pageurl': 'http://books.google.com.au/books?id=im-No5TYyy8C&pg=PA517&dq=%22awg%22&hl=en&sa=X&ei=k5wEUbnbB8OhkQXZtoEY&redir_esc=y#v=onepage&q=%22awg%22&f=false', 'page': '517'}
        ),
        (
            # editors, author
        ...
        (
            ...
            {'year': '2006', 'author': 'Timothy M. Gay', 'title': 'Tris Speaker: The Rough-and-Tumble Life of a Baseball Legend', 'page': '37', 'publisher': 'U of Nebraska Press', 'isbn': '0803222068'}
        ),
        (
            # Pages in link text
        ...
        (
            ...
            {'year': '2014', 'author': 'Larisa Kharakhinova', 'title': "Heart-to-heart letters: to MrRight from '''CCCP'''", 'page': '22', 'publisher': 'Litres', 'isbn': '9785457226449'}
        ),
        (
            # OCLC instad of ISBN
            ...
            {'year': '1847', 'author': 'Charles Sealsfield', 'title': 'Rambleton: A Romance of Fashionable Life in New-York during the Great Speculation of 1836', 'page': '127', 'oclc': '12337689'}
        ),
        (
...
#        ),
        ...
        (
            ...
            {'date': '29 Oct 1974', 'chapter': 'Sports: Full-time Franco Busts A Couple, Rushes For 141', 'chapterurl': 'http://news.google.ca/newspapers?id=mWkqAAAAIBAJ&sjid=xVUEAAAAIBAJ&pg=4318,6028745&dq=did-a-number-on&hl=en', 'title': 'Pittsburgh Press', 'accessdate': '20 Aug. 2010', 'page': '26'}
        ),
        (
            ...
            {'date': '18 May 1970', 'chapter': 'Alive and Well', 'chapterurl': 'https://web.archive.org/web/20130822174940/http://www.time.com/time/magazine/article/0,9171,909210,00.html', 'title': 'Time'}
        ),
        (
        ...
        (
            ...
            {'year': '1977', 'translator': 'Olga Kuthanová', 'author': 'Jan Hanzák', 'author2': 'Jiří Formánek', 'title': 'The Illustrated Encyclopedia of Birds', 'page': '177', 'location': 'London', 'year_published': '1992'}
        ),
        (
        ...
        (
            ...
            {'year': '1892', 'translator': 'Carl Deite', 'author': 'William Theodore Brannt', 'title': 'A Practical Treatise on the Manufacture of Perfumery', 'page': '230'}
        ),
        (
            """'''1727''', John Gaspar Scheuchzer translating Engelbert Kaempfer's ''History of Japan'', Vol. I, p. 287:""",
             {'year': '1727', 'translator': 'John Gaspar Scheuchzer', 'author': 'Engelbert Kaempfer', 'title': 'History of Japan', 'volume': 'I', 'page': '287'}
        ),
        (
...
#        ( """'''1980''', {{w|William S. Laughlin}}, ''Aleuts: Survivors of the Bering Land Bridge,'' New York: Holt, Rinehart, and Winston, p.{{nbsp}}144,<sup>[https://archive.org/details/aleutssurvivorso00laug/page/144/mode/1up?q=acephalic]</sup>""",
#            ('year', 'author', 'italics', 'location', 'unhandled<Holt, Rinehart, and Winston>', 'page', 'url'),
#            None # Not handled because , in unhandled publesher
#        ),
        (
...
#            {'_source': 'book', 'year': '1933', 'author': '{{w|James Hilton (novelist)|James Hilton}}', 'title': '{{w|Lost Horizon}}', 'location': 'New York', 'publisher': 'Pocket Books', 'year_published': '1939', 'chapter': '3', 'page': '59', 'pageurl': 'https://archive.org/details/isbn_0671664271'}
...
#        ( """'''1638''', {{w|Sir Thomas Herbert, 1st Baronet|Thomas Herbert}}, ''Some Yeares Travels into Divers Parts of Asia and Afrique,'' London: Jacob Blome and Richard Bishop, p.{{nbsp}}17,<sup>[http://name.umdl.umich.edu/A03066.0001.001]</sup>""",
#            ('year', 'author', 'italics', 'location', 'unhandled<Jacob Blome and Richard Bishop>', 'page', 'url'),
#            {'_source': 'book', 'year': '1638', 'author': '{{w|Sir Thomas Herbert, 1st Baronet|Thomas Herbert}}', 'title': 'Some Yeares Travels into Divers Parts of Asia and Afrique', 'location': 'London', 'publisher': 'Jacob Blome and Richard Bishop', 'page': '17', 'url': 'http://name.umdl.umich.edu/A03066.0001.001'}
#        ),
#        (
#            """'''1863''', {{w|Jean Ingelow}}, “Afternoon at a Parsonage” in ''Poems,'' London: Logmans, Green, Reader & Dyer, p.{{nbsp}}174,<sup>[https://archive.org/details/poemsingelow00inge/page/174/mode/1up?q=atremble]</sup>""",
#            ('year', 'author', 'fancy_double_quotes', 'italics', 'location', 'unhandled<Logmans, Green, Reader & Dyer>', 'page', 'url'),
#            None, # unhandled publisher can't contain commas
#            #{'_source': 'book', 'year': '1863', 'author': '{{w|Jean Ingelow}}', 'chapter': 'Afternoon at a Parsonage', 'title': 'Poems', 'location': 'London', 'publisher': 'Logmans, Green, Reader & Dyer', 'page': '174', 'url': 'https://archive.org/details/poemsingelow00inge/page/174/mode/1up?q=atremble'}
#        ),
#        ( """'''1898''', Henry A. Castle, “The Army Mule” in ''The Army Mule, and Other War Sketches'', Indianapolis: Bowen-Merrill, p. 29,<sup>[https://archive.org/details/armymuleotherwar01cast]</sup>""",
#            ('year', 'author', 'fancy_double_quotes', 'italics', 'location', 'unhandled<Bowen-Merrill>', 'page', 'url'),
#            {'_source': 'book', 'year': '1898', 'author': 'Henry A. Castle', 'chapter': 'The Army Mule', 'title': 'The Army Mule, and Other War Sketches', 'location': 'Indianapolis', 'publisher': 'Bowen-Merrill', 'page': '29', 'url': 'https://archive.org/details/armymuleotherwar01cast'}
#        ),
#        (
#            """'''1715''', {{w|Alexander Pope}}, “An Essay on the Life, Writings and Learning, of Homer” in ''The {{w|Iliad}} of {{w|Homer}}'', London: Bernard Lintott, p. 51,<sup>[http://name.umdl.umich.edu/004836009.0001.001]</sup>""",
#            ('year', 'author', 'fancy_double_quotes', 'italics', 'location', 'unhandled<Bernard Lintott>', 'page', 'url'),
#            {'_source': 'book', 'year': '1715', 'author': '{{w|Alexander Pope}}', 'chapter': 'An Essay on the Life, Writings and Learning, of Homer', 'title': 'The {{w|Iliad}} of {{w|Homer}}', 'location': 'London', 'publisher': 'Bernard Lintott', 'page': '51', 'url': 'http://name.umdl.umich.edu/004836009.0001.001'}
#        ),
#        (
#            """'''1633''', {{w|John Donne}}, “The Indifferent” in ''Poems'', London: John Marriot, p. 200,<sup>[http://name.umdl.umich.edu/A69225.0001.001]</sup>""",
#            ('year', 'author', 'fancy_double_quotes', 'italics', 'location', 'unhandled<John Marriot>', 'page', 'url'),
#            {'_source': 'book', 'year': '1633', 'author': '{{w|John Donne}}', 'chapter': 'The Indifferent', 'title': 'Poems', 'location': 'London', 'publisher': 'John Marriot', 'page': '200', 'url': 'http://name.umdl.umich.edu/A69225.0001.001'}
#        ),
 ...
 #      ),
        ...
        (
            ...
            {'_source': 'book', 'year': '2016', 'author': '{{w|Alan Moore}}', 'title': 'Jerusalem', 'publisher': 'Liveright', 'year_published': '2016', 'page': '180'}
        ),
        (
            """'''2006''', John G. Radcliffe, ''The Geometry of Hyperbolic Manifolds of Dimension a least 4'', András Prékopa, Emil Molnár (editors), ''Non-Euclidean Geometries: János Bolyai Memorial Volume'', [https://books.google.com.au/books?id=ZXgKflOpXc8C&pg=PA270&dq=%22120-cell%22%7C%22120-cells%22&hl=en&sa=X&ved=0ahUKEwjb3q7Siu3MAhUj5aYKHYosD-IQ6AEIWDAM#v=onepage&q=%22120-cell%22%7C%22120-cells%22&f=false page 270],""",
...
#        ),
        (
            ...
            ('year', 'italics', 'paren::volumes', 'paren::page'),
        ...
        (
            ...
            ('year', 'author', 'italics', 'paren::italics', 'paren::date', 'url'),
            {'_source': 'journal', 'date': '3 January 2013', 'author': 'Luke Harding', 'author2': 'Uki Goni', 'journal': 'The Guardian', 'url': 'http://www.guardian.co.uk/uk/2013/jan/02/argentina-britain-hand-back-falklands'}
        ),
        (
            ...
            ('date', 'author', 'url', 'url::double_quotes', 'italics'),
