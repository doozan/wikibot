...
def main():
    ...
    if args.wxt:
        iter_entries = iter_wxt(args.wxt, args.limit, args.progress, args.t)
    else:
        iter_entries = iter_xml(args.xml, args.limit, args.progress, args.t)
...
def process(args):
    ...
    entry_text, entry_title, templates = args
